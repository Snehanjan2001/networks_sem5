from helpers import BinaryToString, ReadNoOfZerosAndOnes, buildFrames, generateDivisor, polynomialStringParser
...
if __name__ == "__main__":
    ...
    if decodingMethod not in ["VRC", "LRC", "CRC", "CHECKSUM"]: raise Exception(
    ...
    print("Decoding technique     : ",
          decodingMethod + " " + selectedPolynomial if decodingMethod == "CRC" else decodingMethod)
